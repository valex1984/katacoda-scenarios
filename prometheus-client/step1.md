...
Также у Prometheus есть возможность получать список таргетов динамически с помощью различных методов обнаружения (service discovery): например, из kubernetes, consul, файлов и т.д.
